    ...
    return (
      <div className="section-wrapper flex-col" id="pricing">
          ...
          <div className="flex-row">
              ...
              <PriceCard track={'Web Dev: 6 sessions'}
                         price={'$350 flat rate'}
                         style={{minHeight: '352px'}}
                         details={<span>This option is designed for students that already have experience programming, but want to build practical skills in <strong>full-stack web development</strong>. This package includes the 6 Web Dev sessions.</span>}/>
              <PriceCard track={'Core Concepts + Web Dev: 14 sessions'}
                         price={'$750 flat rate'}
                         style={{minHeight: '352px'}}
